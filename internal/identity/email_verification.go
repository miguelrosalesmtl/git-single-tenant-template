...
//
// Verification does not gate login -- locking somebody out of their own account
// because a verification email went to spam is a support nightmare for very
// little gain. It is offered as a standalone signal (User.EmailVerifiedAt) that
// your own product code can gate whatever it likes on.
